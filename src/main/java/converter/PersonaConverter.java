...
public class PersonaConverter extends EntityConverter implements Converter
{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value)
    {
        ...
        return getViewMap(context).get(value+Persona.class.getName());
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object)
    {
        ...
        try
        {
            Integer id = ((Persona) object).getId();
            if (id != null)
            {
                getViewMap(context).put(id.toString()+Persona.class.getName(), object);
